class DummyUsersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @dummy_user.save
        ...
        format.json { render :show, status: :created, location: @dummy_user }
      else
  ...
  def update
    respond_to do |format|
      if @dummy_user.update(dummy_user_params)
        ...
        format.json { render :show, status: :ok, location: @dummy_user }
      else
  ...
  def destroy
    @dummy_user.destroy
    respond_to do |format|
      format.html { redirect_to dummy_users_url, notice: 'Dummy user was successfully destroyed.' }
  ...
  private
    ...
    def dummy_user_params
      params.require(:dummy_user).permit(:email, :password)
    end
end
